...
namespace Rebirth.Prototype
{
    ...
    {
        public const float MIN_DISTANCE_TO_PLAYER = 1f;
        public const float MAX_DISTANCE_TO_PLAYER = 4f;
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (this.camera.GetComponent<CameraController>().m_cursorIsLocked) this.UpdateCameraPosition();
        ...
        private void UpdateCameraPosition()
        {
            ...
            this.transform.localPosition = Vector3.SmoothDamp(this.transform.localPosition, newCameraLocalPosition, ref this.cameraVelocity, this.occlusionMoveTime);
        }
